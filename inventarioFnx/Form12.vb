Public Class Form12
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Dim respuestamensaje As Integer = MsgBox("¿ Deseas retirar este fondo de caja ?" + vbCrLf.ToString + "Estas piezas se adicionaran al inventario.", vbYesNo, "Aviso")
        If respuestamensaje = 6 Then
            ...
            Try
                ...
                Dim getId As Integer = inserta.insertRetiroFondo(fondo)
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        e.Graphics.DrawString("DETALLE DEL RETIRO FONDO DE CAJA", fuente, Brushes.Black, 0, 170)
        e.Graphics.DrawLine(blackPen, point3, point4)

        e.Graphics.DrawString(ticketCabeza.getRetiroFondoCajaDetalle(Me.id), fuente, Brushes.Black, 0, 180)
